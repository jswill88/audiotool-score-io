...
const sourceCodeUrl = 'https://github.com/jswill88/audiotool-score-export';
...
function GitHubMark() {
  return (
    <svg aria-hidden="true" width="15" height="15" viewBox="0 0 16 16" focusable="false">
      <path
        fill="currentColor"
